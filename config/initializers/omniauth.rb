...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  scope: %W( email user_about_me  user_activities  user_birthday  user_groups  user_hometown  user_interests  user_likes 
             user_location  user_relationships  user_relationship_details  user_religion_politics  user_subscriptions 
             user_events  friends_about_me  friends_activities  friends_birthday  friends_groups  friends_hometown  
             friends_interests  friends_likes  friends_location  friends_relationships  friends_relationship_details  
             friends_religion_politics  friends_subscriptions  friends_events publish_actions).join(',')
